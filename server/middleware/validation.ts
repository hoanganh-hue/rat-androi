...
export const userValidation = {
  ...
  delete: [param("id").isUUID().withMessage("Invalid user ID"), validate],
};
...
export const deviceValidation = {
  getById: [param("id").isUUID().withMessage("Invalid device ID"), validate],
  ...
  delete: [param("id").isUUID().withMessage("Invalid device ID"), validate],
