 ...
 */
router.post('/register', authValidation.register, async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const assignedRole = userCount === 0 ? UserRole.ADMIN : (role || UserRole.VIEWER);
 ...
 */
router.post('/login', authValidation.login, async (req: Request, res: Response): Promise<void> => {
  try {
